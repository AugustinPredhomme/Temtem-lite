...
const Trades = () => {
  ...
  // Fetch the user's inventory (temtems they own)
  const { data: inventory, isLoading: inventoryLoading } = useQuery({
    ...
    enabled: !!userId,  // Ensure this runs only if userId is available
  });

  // Mutation to create a trade
  ...
  useEffect(() => {
    // Filter Temtems from the user's inventory
